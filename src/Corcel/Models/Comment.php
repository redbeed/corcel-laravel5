...
use Corcel\Builder\CommentBuilder;

class Comment extends CorcelModel
{
    ...
    {
        return $this->belongsTo('Corcel\Models\Post', 'comment_post_ID');
    }
    ...
    {
        return $this->belongsTo('Corcel\Models\Comment', 'comment_parent');
    }
    ...
    {
        return $this->hasMany('Corcel\Models\Comment', 'comment_parent');
    }
