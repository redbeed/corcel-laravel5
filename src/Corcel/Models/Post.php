...
use Corcel\Builder\PostBuilder;
...
class Post extends CorcelModel
{
    ...
    {
        return $this->hasMany('Corcel\Models\PostMeta', 'post_id');
    }
    ...
    {
        return $this->belongsToMany('Corcel\Models\TermTaxonomy', 'term_relationships', 'object_id', 'term_taxonomy_id');
    }
    ...
    {
        return $this->hasMany('Corcel\Models\Comment', 'comment_post_ID');
    }
    ...
    */
    public function author(){
        ...
        return $this->belongsTo('Corcel\Models\Author', 'post_author', 'ID');
    ...
    {
        return $this->hasMany('Corcel\Models\Post', 'post_parent')->where('post_type', 'attachment');
    }
    ...
    {
        return $this->hasMany('Corcel\Models\Post', 'post_parent')->where('post_type', 'revision');
    }
